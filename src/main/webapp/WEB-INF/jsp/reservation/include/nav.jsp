...
<nav class="d-flex align-items-center justify-content-center mt-3">
	<ul class="nav w-100 nav-fill">
		...
		<li class="nav-item d-flex align-items-center justify-content-center">
			<a href="/reservation/traffic_create_view?travelId=${travel.id}" class="nav-link"> 
		...
		<li class="nav-item d-flex align-items-center justify-content-center">
			<a href="/reservation/accommodation_create_view?travelId=${travel.id}" class="nav-link"> <img
		...
		<li class="nav-item d-flex align-items-center justify-content-center">
			<a href="/reservation/reservation_create_view?travelId=${travel.id}" class="nav-link"> <img
