...
<div class="mypage">
		<a href="/travel/mypage_view" class="d-flex justify-content-end"> <span
		...
		<div class="mt-2 mr-3">
			 <c:choose>
				<c:when test="${reservationSubject == 'traffic'}">
					<a href="/itinerary/traffic_info_view?userId=${userId}&travelId=${travel.id}" class="mt-2">
						<img src="/static/icons/airplans_black.png" id="airplanImg" 
							alt="비행기아이콘" width="30px">
					</a>
				</c:when>
				<c:when test="${reservationSubject == 'accommodation'}">
					<a href="/itinerary/accommodation_info_view?userId=${userId}&travelId=${travel.id}" class="mt-2">
						<img src="/static/icons/airplans_black.png" id="airplanImg" 
							alt="비행기아이콘" width="30px">
					</a>
				</c:when>
				<c:when test="${reservationSubject == 'reservation'}">
					<a href="/itinerary/reservation_info_view?userId=${userId}&travelId=${travel.id}" class="mt-2">
						<img src="/static/icons/airplans_black.png" id="airplanImg" 
							alt="비행기아이콘" width="30px">
					</a>
				</c:when>
