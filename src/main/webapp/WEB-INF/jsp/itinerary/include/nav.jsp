...
<div class="ml-4 mt-3">
	...
	<ul class="nav flex-column">
		<li class="nav-item my-2">
			<a class="nav-link" href="/itinerary/traffic_info_view?userId=${userId}&travelId=${travel.id}">
				<div class="d-flex">
				...
				<small class="nav-smText font-weight-bold ml-4 pl-3">
					<fmt:formatNumber value="${tafficPrice}" type="currency"/>
				</small>
			</a> 
		</li>
		<li class="nav-item">
			<a class="nav-link font-weight-bold" 
				href="/itinerary/accommodation_info_view?userId=${userId}&travelId=${travel.id}">
				<div class="d-flex">
					<img alt="숙소아이콘" src="/static/icons/accommodation.png" width="20px" height="20px">
					<div class="nav-Text font-weight-bold ml-3">숙   소</div>	
				</div>
				<small class="nav-smText font-weight-bold ml-4 pl-3">
					<fmt:formatNumber value="${accommodationPrice}" type="currency"/>
				</small>
			</a>
		</li>
		<li class="nav-item my-2">
			<a class="nav-link font-weight-bold" 
				href="/itinerary/reservation_info_view?userId=${userId}&travelId=${travel.id}">
				<div class="d-flex">
				...
				<small class="nav-smText font-weight-bold ml-4 pl-3">
					<fmt:formatNumber value="${reservationPrice}" type="currency"/>
				</small>
			</a>
		</li>
		<li class="nav-item">
			<a class="nav-link font-weight-bold" 
				href="/itinerary/date_list_view?userId=${userId}&travelId=${travel.id}">
				<div class="d-flex">
